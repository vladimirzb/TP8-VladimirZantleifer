                    ...
                    <div class="col-md-12">                        
                        <div class="card">                            
                            <div class="card-header text-right">
                                <a href="agregar-producto.html" class="btn btn-warning"><i class="fa fa-plus"></i> Agregar Producto</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Descuento actual <i class="fa   fa-certificate"></i> </th>
                                            <th>Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>25</td>  
                                            <td>11 <i class="fa  fa-usd"> </i></td>
                                            <td>11% <i class="fa  fa-certificate"> </i></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>23</td>
                                            <td>11 <i class="fa  fa-usd"> </i></td>
                                            <td>15% <i class="fa  fa-certificate"> </i></td>                                             
                                            <td>
                                                <a href="modificar-producto.html" class="btn btn-primary"><i class="fa fa-edit"></i> Editar</a>
                                                <a href="#" class="btn btn-danger"><i class="fa fa-trash-o"></i> Eliminar</a>
                                                <a href="#" class="btn btn-secondary"> Activar/Desactivar</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>45</td>
                                            <td>11 <i class="fa  fa-usd"> </i></td>    
                                            <td>17% <i class="fa  fa-certificate"> </i></td>                                         
                                            <td>
                                                <a href="modificar-producto.html" class="btn btn-primary"><i class="fa fa-edit"></i> Editar</a>
                                                <a href="#" class="btn btn-danger"><i class="fa fa-trash-o"></i> Eliminar</a>
                                                <a href="#" class="btn btn-secondary"> Activar/Desactivar</a>
